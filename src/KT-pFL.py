...
from engine_kt_pfl import train_models,KT_pFL
#from engine_learnweight import train_models,KT_pFL
...
def main():
    ...
    kt_pfl = KT_pFL(parties,
                  ...
                  KT_pFL_params = conf_dict['KT_pFL_params'],
                  ...
                  device=device)
    '''计算理论上线和初始化各个客户模型'''
    initialization_result = kt_pfl.init_result
    pooled_train_result = kt_pfl.pooled_train_result
    '''联邦蒸馏学习'''
    collaboration_performance = kt_pfl.collaborative_training()
