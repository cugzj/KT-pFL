...
class KT_pFL_cos():
    def __init__(self, parties, public_dataset,
        ...
        self.N_alignment = KT_pFL_cos_params['N_alignment']

        self.N_rounds = KT_pFL_cos_params['N_rounds']
        self.N_logits_matching_round = KT_pFL_cos_params['N_logits_matching_round']
        self.logits_matching_batchsize = KT_pFL_cos_params['logits_matching_batchsize']
        self.N_private_training_round = KT_pFL_cos_params['N_private_training_round']
        self.private_training_batchsize = KT_pFL_cos_params['private_training_batchsize']
        self.device = device
    ...
    def collaborative_training(self):
        ...
        while True:
            ...
            for index, model in enumerate(self.collaborative_parties):
                ...
                with open('./result/fmnist_cos_20models_4labels_15local.txt', 'a') as f:
                    f.write('{}\t{}\t{}\n'.format(r, index, acc))
