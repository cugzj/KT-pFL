...
from engine_topk import train_models,KT_pFL_topk
#from engine_learnweight import train_models,KT_pFL_topk
...
def main():
    ...
    '''联邦蒸馏学习'''
    kt_pfl_topk = KT_pFL_topk(parties,
                  public_dataset=public_dataset,
                  private_data=private_data,
                  total_private_data=total_private_data,
                  private_test_data=private_test_data,
                  KT_pFL_topk_params = conf_dict['KT_pFL_topk_params'],
                  ...
                  device=device)
    '''计算理论上线和初始化各个客户模型'''
    initialization_result = kt_pfl_topk.init_result
    pooled_train_result = kt_pfl_topk.pooled_train_result
    '''联邦蒸馏学习'''
    collaboration_performance = kt_pfl_topk.collaborative_training()
